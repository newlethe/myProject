...
Ext.grid.QueryExcelEditorGridPanel = Ext.extend(Ext.grid.EditorGridPanel, {
 ...
 */	
	...
	onRender : function(ct, positon){
		Ext.grid.QueryExcelEditorGridPanel.superclass.onRender.call(this, ct, positon);
		...
		function showWindow(){
	 		if(!formWin){
				formWin = new Ext.Window({	               
					title: '查询数据',
					width: 460, minWidth: 460, height: 400,
