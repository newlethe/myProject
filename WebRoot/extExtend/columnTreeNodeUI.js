    ...
    onRender : function(){
        ...
        for(var i = 0, len = cols.length; i < len; i++){
             ...
             this.headers.createChild({
                 ...
                 style:(c.width-this.borderWidth)<=0?'display:none':'width:'+(c.width-this.borderWidth)+'px;'
             });
        }
...
Ext.tree.ColumnNodeUI = Ext.extend(Ext.tree.TreeNodeUI, {
	...
	renderElements : function(n, a, targetNode, bulkRender){
		...
		var buf = [ '<li class="x-tree-node"><div ext:tree-node-id="',n.id,'" class="x-tree-node-el x-tree-node-leaf ', a.cls,'">',
                '<div class="x-tree-col" style="',(c.width-bw<=0?"display:none;":"width:"+(c.width-bw)+"px;"),'">',
		...
		for(var i=1,len=cols.length; i<len; i++){
			c = cols[i];
			buf.push('<div class="x-tree-col ',(c.cls?c.cls:''),'" style="',(c.width-bw<=0?"display:none;":"width:"+(c.width-bw)+"px;"),'">',
