...
String sql = "select unitid,unitname,"
			+ " (select count(unitid) from sgcc_ini_unit where upunit=t.unitid and (unit_type_id in ('0','9') or unitid='" + unitID + "')) as leaf,rownum"
			+ " from (select unitid,unitname,upunit from sgcc_ini_unit where (unit_type_id in ('0','9') or unitid='" + unitID + "')) t"
