...
public class EquGoodsStoreinEstimate implements java.io.Serializable {
	...
	/** default constructor */
	public EquGoodsStoreinEstimate() {
	}

	/** minimal constructor */
	public EquGoodsStoreinEstimate(String uids, String pid) {
		this.uids = uids;
		this.pid = pid;
	}

	/** full constructor */
	public EquGoodsStoreinEstimate(String uids, String pid, String conid,
			byte finished, String treeUids, String warehouseNo,
			String warehouseInType, Date warehouseDate, String noticeNo,
			String warehouseMan, String makeMan, String remark,
			String abnormalOrNo, String openBoxId,String dataType,
			String createUnit,String createMan,String joinUnit) {
		this.uids = uids;
		this.pid = pid;
		this.conid = conid;
