...
public class EquGoodsOutEstimateSub implements java.io.Serializable {
	...
	/** default constructor */
	public EquGoodsOutEstimateSub() {
	}

	/** minimal constructor */
	public EquGoodsOutEstimateSub(String pid,String stockId, String outId, String outNo) {
		this.pid = pid;
	...
	public EquGoodsOutEstimateSub(String pid, String stockId,String outId, String outNo,
			...
			String graphNo, String unit, Double outNum,Double kcMoney, 
			String storage) {
		this.pid = pid;
		this.stockId = stockId;
		this.outId = outId;
