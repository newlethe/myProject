...
/**
 * EquGoodsOpenboxSubPart entity. @author MyEclipse Persistence Tools
 */

public class EquGoodsOpenboxSubPart implements java.io.Serializable {
	...
	/** default constructor */
	public EquGoodsOpenboxSubPart() {
	}

	/** minimal constructor */
	public EquGoodsOpenboxSubPart(String openboxSubId) {
		this.openboxSubId = openboxSubId;
	}

	/** full constructor */
	public EquGoodsOpenboxSubPart(String uids, String openboxSubId,
			String equType, String openboxId, String openboxNo, String pid,
			String jzNo, String treeuids, String boxNo, String equPartName,
			String ggxh, String graphNo, String unit, Double boxinNum,
			Double weight, String storage,String equBodys,String userPosition,
			String belongSystem,String openCondition,String defectDescription) {
		super();
		this.uids = uids;
		this.openboxSubId = openboxSubId;
