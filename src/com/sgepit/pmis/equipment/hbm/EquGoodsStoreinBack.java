...
public class EquGoodsStoreinBack  implements java.io.Serializable {
	...
	/** default constructor */
	public EquGoodsStoreinBack() {
	}

	/** minimal constructor */
	public EquGoodsStoreinBack(String uids, String pid) {
		this.uids = uids;
		this.pid = pid;
	}

	/** full constructor */
	public EquGoodsStoreinBack(String uids, String pid, String conid,
			...
			String dataType,String createMan,String createUnit,String joinUnit) {
		this.uids = uids;
		this.pid = pid;
		this.conid = conid;
