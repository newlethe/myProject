...
public class SafeCasualtyAccident implements java.io.Serializable {
	...
	/** default constructor */
	public SafeCasualtyAccident() {
	}

	/** minimal constructor */
	public SafeCasualtyAccident(String sgbh) {
		this.sgbh = sgbh;
	}

	/** full constructor */
	public SafeCasualtyAccident(String sgbh, String sgmc, String sglb,
