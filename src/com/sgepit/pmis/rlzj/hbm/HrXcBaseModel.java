...
/**
 * HrXcBaseModel entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class HrXcBaseModel implements java.io.Serializable {
	...
	/** default constructor */
	public HrXcBaseModel() {
	}

	/** minimal constructor */
	public HrXcBaseModel(String lsh, String sjType, String unitId,
			String zbSeqno) {
		this.lsh = lsh;
		this.sjType = sjType;
		this.unitId = unitId;
