...
/**
 * KqDaystjCompXb entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class KqDaystjCompXb implements java.io.Serializable {
	...
	/** default constructor */
	public KqDaystjCompXb() {
	}

	/** minimal constructor */
	public KqDaystjCompXb(String detailId, String masterlsh, String sjType,
			String unitId) {
