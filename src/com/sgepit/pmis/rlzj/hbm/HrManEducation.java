...
/**
 * HrManEducation entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class HrManEducation implements java.io.Serializable {
	...
	/** default constructor */
	public HrManEducation() {
	}

	/** minimal constructor */
	public HrManEducation(String seqnum, String personnum) {
		this.seqnum = seqnum;
		this.personnum = personnum;
	}

	/** full constructor */
	public HrManEducation(String seqnum, String personnum, String organname,
			Date starttime, Date endtime, String major, String achievement,
			String memo, String memoc1, String memoc2, String memoc3,
			String memoc4, String memoc5, String memoc6, String memoc7,
			String memoc8, String memoc9, String memoc10, Long memon1,
			Long memon2, Long memon3, Long memon4, Long memon5, Date memod1,
			Date memod2, Date memod3, Date memod4, Date memod5,
