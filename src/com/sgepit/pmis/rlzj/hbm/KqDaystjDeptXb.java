...
/**
 * KqDaystjDeptXb entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class KqDaystjDeptXb implements java.io.Serializable {
	...
	/** default constructor */
	public KqDaystjDeptXb() {
	}

	/** minimal constructor */
	public KqDaystjDeptXb(String detailId, String masterlsh, String sjType,
			String unitId) {
