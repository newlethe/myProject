...
public class HrXcSalaryTjD implements java.io.Serializable {
...
//	private Double val27;
	...
	/** default constructor */
	public HrXcSalaryTjD() {
	}

	/** minimal constructor */
	public HrXcSalaryTjD(String detailId, String masterlsh, String sjType,
	...
	/** full constructor */
	public HrXcSalaryTjD(String detailId, String masterlsh, String sjType,
			String unitId, String zbSeqno, Double val1, Double val2,
			Double val3, Double val4, Double val5
/*			, Double val6, Double val7,
			Double val8, Double val9, Double val10, Double val11, Double val12,
			Double val13, Double val14, Double val15, Double val16,
			Double val17, Double val18, Double val19, Double val20,
			Double val21, Double val22, Double val23, Double val24,
			Double val25, Double val26, Double val27*/
			, String memo) {
		this.detailId = detailId;
		this.masterlsh = masterlsh;
		this.sjType = sjType;
...
/*	public Double getVal6() {
	...
	public void setVal27(Double val27) {
		this.val27 = val27;
	}*/
