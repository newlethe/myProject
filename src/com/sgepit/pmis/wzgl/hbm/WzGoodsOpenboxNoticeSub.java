...
public class WzGoodsOpenboxNoticeSub implements java.io.Serializable {
	...
	/** default constructor */
	public WzGoodsOpenboxNoticeSub() {
	}

	/** minimal constructor */
	public WzGoodsOpenboxNoticeSub(String pid, String noticeId) {
		this.pid = pid;
		this.noticeId = noticeId;
	}

	/** full constructor */
	public WzGoodsOpenboxNoticeSub(String pid, String noticeId, String noticeNo,
