...
public class WzGoodsOpenboxSub implements java.io.Serializable {
	...
	/** default constructor */
	public WzGoodsOpenboxSub() {
	}

	/** minimal constructor */
	public WzGoodsOpenboxSub(String pid, String openboxId) {
		this.pid = pid;
		this.openboxId = openboxId;
	}

	/** full constructor */
	public WzGoodsOpenboxSub(String pid, String openboxId, String openboxNo,
