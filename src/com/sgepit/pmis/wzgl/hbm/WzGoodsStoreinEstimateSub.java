 ...
 */
public class WzGoodsStoreinEstimateSub implements java.io.Serializable{
	...
	/** default constructor */
	public WzGoodsStoreinEstimateSub() {
	}

	/** minimal constructor */
	public WzGoodsStoreinEstimateSub(String uids, String pid) {
		this.uids = uids;
		this.pid = pid;
	}

	/** full constructor */
	public WzGoodsStoreinEstimateSub(String uids, String ggxh, String memo,
