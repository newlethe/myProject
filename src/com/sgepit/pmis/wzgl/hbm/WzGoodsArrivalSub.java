...
public class WzGoodsArrivalSub implements java.io.Serializable {
	...
	private String conmatuids;

	// Constructors

	/** default constructor */
	public WzGoodsArrivalSub() {
	}

	/** minimal constructor */
	public WzGoodsArrivalSub(String pid, String arrivalId) {
		this.pid = pid;
		this.arrivalId = arrivalId;
	}

	/** full constructor */
	public WzGoodsArrivalSub(String pid, String arrivalId, String arrivalNo,
			String boxType,
			...
			String exceptionDesc, String remark,String conmatuids) {
		this.pid = pid;
		this.arrivalId = arrivalId;
	...
	public String getConmatuids() {
		return conmatuids;
	}

	public void setConmatuids(String conmatuids) {
		this.conmatuids = conmatuids;
	}
