...
public class WzGoodsOpenboxResult implements java.io.Serializable {
	...
	/** default constructor */
	public WzGoodsOpenboxResult() {
	}

	/** minimal constructor */
	public WzGoodsOpenboxResult(String pid, String openboxId) {
		this.pid = pid;
	...
	public WzGoodsOpenboxResult(String pid, String openboxId,
			...
			String remark, Double weight, String graphNo) {
		this.pid = pid;
		this.openboxId = openboxId;
