 ...
 */
public class WzGoodsStoreinSub implements java.io.Serializable{
	...
	/** default constructor */
	public WzGoodsStoreinSub() {
	}

	/** minimal constructor */
	public WzGoodsStoreinSub(String uids, String pid) {
		this.uids = uids;
		this.pid = pid;
	}

	/** full constructor */
	public WzGoodsStoreinSub(String uids, String ggxh, String memo, String pid,
			String sbrkUids, String boxNo, String warehouseType,
			...
			String stockno, Double taxes, Double totalnum, Double unitPrice,
			Double amountMoney, Double freightMoney, Double insuranceMoney,
			Double antherMoney, Double amountTax, Double freightTax,
			Double insuranceTax, Double antherTax, String wzSubUids,
			String amountRate, String jzNo) {
		super();
		this.uids = uids;
		this.ggxh = ggxh;
		this.memo = memo;
