...
public class PcZhxxPrjInfo implements java.io.Serializable {
	...
	private String prjQualityTarget;
	...
	public PcZhxxPrjInfo(String uids, String pid, String industryType,
			...
			String guiMoDw,String prjQualityTarget) {
		super();
		this.uids = uids;
		this.pid = pid;
	...
	/** default constructor */
	public PcZhxxPrjInfo() {
	}

	/** minimal constructor */
	public PcZhxxPrjInfo(String pid) {
		this.pid = pid;
	}
