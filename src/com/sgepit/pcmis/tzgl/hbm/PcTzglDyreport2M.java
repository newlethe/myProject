...
/**
 * PcTzglDyreport2M entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class PcTzglDyreport2M implements java.io.Serializable {
	...
	/** default constructor */
	public PcTzglDyreport2M() {
	}

	/** full constructor */
	public PcTzglDyreport2M(String pid, String sjType, String unitId,
			...
			Date memoDate2, String createperson, String unitUsername, 
			String countUsername, String createpersonTel, Date reportDate, 
			String flagNull) {
		this.pid = pid;
		this.sjType = sjType;
		this.unitId = unitId;
