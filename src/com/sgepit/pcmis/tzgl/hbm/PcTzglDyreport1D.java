...
/**
 * PcTzglDyreport1D entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class PcTzglDyreport1D implements java.io.Serializable {
	...
	/** default constructor */
	public PcTzglDyreport1D() {
	}

	/** full constructor */
	public PcTzglDyreport1D(String sjType,
			String unitId, String zbSeqno, Double val1, Double val2,
			Double val3, Double val4, Double val5, Double val6, Double val7,
			Double val8, Double val9, Double val10, String memoVarchar1,
