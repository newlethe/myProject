...
public class ExcelWriter extends BaseWriter {
	...
	public void generateWithName(String xml,String fileName,HttpServletResponse resp){
		parser = new ExcelXmlParser();
		try {
			parser.setXML(xml);
			createExcel(resp);
	...
	/*带文件名的excel导出*/
	private void outputExcel2(String fileName,HttpServletResponse resp) throws IOException, WriteException {
		resp.setContentType("application/vnd.ms-excel");
		resp.setCharacterEncoding("UTF-8");
