   ...
   public Object morph( Class target, Object value )
   {
      ...
      for( int i = 0; i < morphers.length; i++ ){
         ...
         if( morpher.supports( value.getClass() ) ){
            if( morpher instanceof ObjectMorpher ){
            	//System.out.println("net.sf.ezmorph.object.DateMorpher".equals(morpher.getClass().getName()));
            	if("net.sf.ezmorph.object.DateMorpher".equals(morpher.getClass().getName())){
