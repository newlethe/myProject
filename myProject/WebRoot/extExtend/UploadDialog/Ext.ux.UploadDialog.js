...
p.i18n = {
  ...
  add_btn_tip: '添加文件至上传队列',
  remove_btn_text: '移除',
  //remove_btn_text: 'Remove',
  remove_btn_tip: '从上传队列中移除文件',
  ...
  progress_uploading_text: '上传中: 共{0}个文件 ， 已完成{1}个',
  error_msgbox_title: '错误',
  //error_msgbox_title: 'Error',
  permitted_extensions_join_str: ',',
  err_file_type_not_permitted: '所选文件类型被允许。<br/>请选择以下类型的文件: {1}',
  ...
  note_upload_failed: '未找到服务器或网络不可用',
  ...
  note_aborted: '被用户终止终止',
  //note_aborted: 'Aborted by user.',
  note_canceled: '上传已经取消'
