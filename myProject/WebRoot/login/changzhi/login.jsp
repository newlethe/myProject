...
<%
	...
	String imagePath = path + "/login/changzhi/images";
%>
<head>
...
body {
	...
	margin:0;
	background:#C7CDD9 url(<%=imagePath%>/login_001.jpg) repeat-x;
	overflow:hidden;
}
#Main {
	width:1000px;
...
#bg2{
	width:1000px;
	height:298px;
	background:url(<%=imagePath%>/login_003.jpg) 0 0 no-repeat;
	padding:0;
    margin:0;
}
#bg3{
	width:1000px;
	height:126px;
	background:url(<%=imagePath%>/login_005.jpg) 0 0 no-repeat;
	padding:0;
    margin:0;
}
#bg3 p{
...
input.Button1{
	...
	border:none;
	cursor:pointer;
	background:url(<%=imagePath%>/login_006.png) no-repeat center;
}
input.Button1:hover{
	width:76px;
	height:64px;
	border:none;
	cursor:pointer;
	background:url(<%=imagePath%>/login_006f.png) no-repeat center;
}
input.Button2{
	width:67px;
	height:29px;
	border:none;
	cursor:pointer;
	background:url(<%=imagePath%>/login_006.jpg) no-repeat center;
}
.STYLE3 {
	color:#EBEBEB;
...
<body>
   <div id="Main">
      ...
      <div id="bg1"><img src="<%=imagePath%>/login_002.jpg"></div>
	  <div id="bg2">
		  <div id="member">
			<form name="memberLogin" action="#" method="post" align="left" valign="top">
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td>&nbsp;</td>
                  <td rowspan="3"><input name="submit" class="Button1" value="" tabindex="4" onclick="doLogin()"/></td>
                </tr>
                <tr>
                  <td height="8"></td>
                  <td></td>
	  ...
	  <div id="bg3"><p><font color="#B7151C">晋能电力集团有限公司</font></BR>
	  <font color="#B7151C">长治欣隆煤电有限公司  版权所有</font></p></div>
   </div>
</body>
</html>
