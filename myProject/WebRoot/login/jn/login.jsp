...
<%
	...
	String imagePath = path + "/login/jn/images";
%>
<head>
...
body {
	...
	margin:0;
	background:#E6E6E6 url(login/jn/images/login_001.jpg);
}
#Main {
	width:1000px;
	margin:0 auto;
...
#bg2{
	width:1000px;
	height:369px;
	background:url(login/jn/images/login_003.jpg) 0 0 no-repeat;
	padding:0;
    margin:0;
}
#bg3{
...
input.Button1{
	...
	border:none;
	cursor:pointer;
	background:url(login/jn/images/login_06.jpg) no-repeat center;
}
input.Button1:hover{
	width:76px;
	height:64px;
	border:none;
	cursor:pointer;
	background:url(login/jn/images/login_06f.jpg) no-repeat center;
}
input.Button2{
	width:67px;
	height:29px;
...
<body>
   <div id="Main">
      <div id="bg1"><img src="login/jn/images/login_002.jpg"></div>
	  <div id="bg2">
		  <div id="member">
		    <form name="memberLogin" action="#" method="post" align="left" valign="top">
		      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td align="right" class="STYLE1"><input tabindex="3" type="checkbox" name='recordLogin'>&nbsp;<span style='cursor:default' onclick='document.all.recordLogin.click()'>在此计算机上保存我的信息&nbsp;</span></td>
                  <td align="right">&nbsp;</td>
                  <td align="right">&nbsp;</td>
                </tr>
                <tr>
	  ...
	  <div id="bg3"><p>天津市津能投资公司  版权所有</p></div>
   </div>
