...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<%
		...
		String basePath = request.getScheme() + "://"
				...
				+ path + "/";
		String imagePath = path + "/login/tq/images/user_home";
		String backgroundpath = path + "/login/jn/images";
...
.home_bg {
	background:url(<%=backgroundpath%>/fg_07.jpg) 0 72px repeat-x;
	width: 100%;
...
.home_bg #home_bg2 {
	background: url(<%=backgroundpath%>/fg_08.jpg)  no-repeat;
	repeat-x
	width: 100%;
	height: 551px !important;
	height: 580px;
