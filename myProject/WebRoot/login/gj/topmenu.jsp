...
<%@ include file="/jsp/common/golobalJs.jsp"%>
	<%
		String imagePath = path + "/login/gj/images/user_home";		
	%>
...
#home_bg2 .menu {
	width: 800px;
	height: 340px;
	padding: 20px 0 45px 80px !important;
	...
	<body>
		<div class="home_bg">
			<div id="home_bg2">
				...
				<div class="sx">
					<div id="toHome"><a href="http://10.32.2.88:90/" target="_blank"><img src="<%=imagePath%>/ie_hone_96.png" width="96" height="96"/><br>国金门户首页</a></div>
					<div class="text">
