...
<%
	...
	String imagePath = path + "/login/gj/images";
%>
<head>
...
body {
	...
	margin:0;
	background:#E6E6E6 url(<%=imagePath%>/login_001.jpg);
	overflow:hidden;
}
#Main {
	width:1000px;
...
#bg3{
	width:1000px;
	height:126px;
	background:url(login/gj/gj/images/login_005.jpg) 0 0 no-repeat;
	padding:0;
    margin:0;
}
#bg3 p{
...
<body>
   <div id="Main">
	  ...
	  <div id="bg3"><p>山西国金电力有限公司  版权所有</p></div>
   </div>
</body>
</html>
