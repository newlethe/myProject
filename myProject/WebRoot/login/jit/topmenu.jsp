...
.sx {
	width: 800px;
	height: 90px;
	padding: 45px 0 0 160px !important;
}
			...
			<div id="home_bg2">
				<div class="menu">
					<table width="900px" border="0" cellspacing="0" cellpadding="0">
						<c:set var="btnPerRow" scope="page" value="10"></c:set>
						<c:set var="menuCount" scope="page"	value="${ fn:length(allRockPower) }"></c:set>
						<tr>
							<c:forEach items="${allRockPower}" var="rock" varStatus="status">
								...
								<c:if test="${ (status.count mod btnPerRow eq 0) and status.count ne 0 }">
						</tr>
						<tr>
							<td height="20" align="left" valign="top" colspan="14">&nbsp;</td>
						</tr>
						<tr>
							</c:if>
							</c:forEach>
