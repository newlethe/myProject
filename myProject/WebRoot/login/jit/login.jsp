...
body {
	...
	margin:0;
	background:#E6E6E6 url(jsp/res/images/login_sx/login_001.jpg);
}
#Main {
	width:1000px;
	margin:0 auto;
...
#bg2{
	width:1000px;
	height:298px;
	background:url(login/jit/images/login_003_jt.jpg) 0 0 no-repeat;
	padding:0;
    margin:0;
}
#bg3{
	width:1000px;
	height:126px;
	background:url(jsp/res/images/login_sx/login_005.jpg) 0 0 no-repeat;
	padding:0;
    margin:0;
}
#bg3 p{
...
input.Button1{
	...
	border:none;
	cursor:pointer;
	background:url(jsp/res/images/login_sx/login_006.png) no-repeat center;
}
input.Button1:hover{
	width:76px;
	height:64px;
	border:none;
	cursor:pointer;
	background:url(jsp/res/images/login_sx/login_006f.png) no-repeat center;
}
input.Button2{
	width:67px;
	height:29px;
	border:none;
	cursor:pointer;
	background:url(jsp/res/images/login_sx/login_006.jpg) no-repeat center;
}
.STYLE3 {
	color:#EBEBEB;
...
<body>
   <div id="Main">
      <div id="bg1"><img src="login/jit/images/login_002 _jt.jpg" /></div>
	  <div id="bg2">
		  <div id="member">
		    <form name="memberLogin" action="#" method="post" align="left" valign="top">
		      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="27"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="56%" align="left" valign="top"><input type="text" name="username" class="txtBox" tabindex="1"/></td>
                      <td width="4%" align="left" valign="top">&nbsp;</td>
                    </tr>
                  </table></td>
                  <td>&nbsp;</td>
                  <td rowspan="3"><input name="submit" type="button" class="Button1" value="" tabindex="4" onclick="doLogin()" /></td>
                </tr>
                <tr>
                  <td height="8"></td>
                  <td></td>
                ...
                <tr>
                  <td height="27"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="56%" align="left" valign="top"><input type="password" name="password" class="txtBox" tabindex="2"/></td>
                      <td width="4%" align="left" valign="top">&nbsp;</td>
                    </tr>
                  </table></td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td align="right"><input tabindex="3" type="checkbox" name='recordLogin' />&nbsp;<span style='cursor:default' onclick='document.all.recordLogin.click()'>在此计算机上保存我的信息&nbsp;</span></td>
                  <td align="right">&nbsp;</td>
                  <td align="right">&nbsp;</td>
                </tr>
                <tr>
	  ...
	  <div id="bg3"><p>晋能电力集团有限公司  版权所有</p></div>
   </div>
...
<script  type="text/JavaScript">
	...
	function checkLogin()
	{
		...
		if (document.all.username.value == "" || document.all.password.value == "" )//|| document.all.verifycode.value == ""
		{
			...
			Ext.MessageBox.minHeight=120;
			Ext.MessageBox.alert('系统提示','请输入用户名和密码!');
			return false
		}
			...
			failure: function(response, params) {
				...
				processbar.hide();
		  		...
		  		if (response.statusText == "" || "communication failure"){
		  			msg = "系统不能处理当前登录请求！可能是：<li>服务器已断机<li>网络故障，无法连接到服务器</span>";
		  		}
				Ext.MessageBox.show({
		           title: '登录失败！',
		           msg: msg,
