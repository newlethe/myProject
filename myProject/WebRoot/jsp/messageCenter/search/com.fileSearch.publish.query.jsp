...
var g_canOlEdit= <%=canOnlineEdit%>;
		...
		<script type='text/javascript' src='<%=path%>/jsp/messageCenter/search/com.fileSearch.publish.query.left.js'></script>
		<script type='text/javascript' src='<%=path%>/dwr/interface/db2Json.js'></script>

		<!-- 功能JS -->
		<script type='text/javascript'
			src='<%=path%>/jsp/messageCenter/search/com.fileSearch.publish.query.js'>
		</script>
		<script type='text/javascript'
