...
<%	
	...
	String rootId = request.getParameter("rootId") == null ? "info_root"
...
.icon-collapse-all {
	background-image: url("<%=path%>/jsp/res/images/index/collapse-all.gif")
		...
		<script type='text/javascript'
			src='<%=path%>/extExtend/TreeGrid/TreeGrid.js'>
</script>
		...
		<script type='text/javascript' src='dwr/interface/ComFileManageDWR.js'>
</script>

		<!-- 功能JS -->
		<script type='text/javascript'
			src='<%=path%>/Business/jsp/common/fileBlob/fileBlobUpload.js'>
</script>
		<script type='text/javascript'
			src='<%=path%>/jsp/messageCenter/search/com.fileManage.upload.query.left.js'>
</script>
		<script type='text/javascript'
			src='<%=path%>/jsp/messageCenter/search/com.fileManage.upload.query.js'>
</script>
		<script type='text/javascript'
			src='<%=path%>/jsp/messageCenter/search/searchField.js'>
</script>
