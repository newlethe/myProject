 ...
 <html>
	<head>
		...
		<script type="text/javascript">
			...
			var edit_accidentType = "<%=request.getParameter("edit_accidentType")==null?"":request.getParameter("edit_accidentType")%>";
		</script>
		...
		<script type="text/javascript" src="PCBusiness/aqgk/baseInfoInput/pc.aqgk.baseInfoInput.accident.js"></script>
	</head>
	<body >
	</body>
</html>