...
Ext.onReady(function (){
    ...
    baseMgm.findById('com.sgepit.pmis.contract.hbm.ConOve',g_conid,function(obj){
        conObj = obj;
    })
	...
	tplstr += "<tr>";
	tplstr += "<td class='viewLabel'>合同名称</td><td class='viewData'>"+conObj.conname+"</td>";
	tplstr += "<td class='viewLabel'>合同编号</td><td class='viewData'>"+conObj.conno+"</td>";
