...
var curSjType = curDate.getYear();
var sjType=curSjType;				
...
function onloadFn(mygrid){
	last_year=parseInt(sjType)-1;
	//mygrid.setHeaderCol(11,"至"+last_year+"年底累计完成投资");
}
function getQueryStr(){
	...
	queryStr += '&headtype=INVEST_YEAR_PLAN_REPORT_MULTIPRJ';	//类型
