...
Ext.onReady(function () {
    ...
    new Ext.grid.RowNumberer(),
    {
        ...
        renderer: function (v, m, r) {
            return "<a href=javascript:todetail(\"" + r.get('pid') + "\",\"" + v + "\");>" + v + "</a>"
        }
    }, {
        id: 'industry_type',
        type: 'string',
        ...
        dataIndex: 'pid',
        renderer: function (v) {
            return "<a href='javascript:foundSrcEditWindow(\"" + v + "\")'>资金来源</a>"
        }
    }, {
        id: 'prj_intro',
        align: 'center',
...
function todetail(pid, proname) {
    switchoverProj(pid, proname);
    window.location.href = BASE_PATH + "PCBusiness/zhxx/query/pc.zhxx.search.detail.jsp";
}