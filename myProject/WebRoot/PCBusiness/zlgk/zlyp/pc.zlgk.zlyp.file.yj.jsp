...
<%
	...
	String uuid = request.getParameter("uuid")==null?"1=1":request.getParameter("uuid").toString();
	
%>
<%@ include file="/jsp/common/golobalJs.jsp"%>
<html>
	<head>
		<title>质量验评文件移交</title>
		<style>
			.icon-expand-all {
		...
		<script type='text/javascript'
			src='<%=path%>/PCBusiness/zlgk/zlyp/pc.zlgk.zlyp.file.yj.js'></script>
	</head>
	<body>
