 ...
 <html>
	<head>
		...
		<script type="text/javascript">
			/**主记录上报后，_flag==flase，此时报表内容不可修改**/
			var _flag = "<%=request.getParameter("flag")==null?"true":request.getParameter("flag")+""%>" 
		</script>
		<!-- DWR -->
		...
		<script type="text/javascript" src="PCBusiness/jdgk/sgepit.util.js"></script>
		<script type="text/javascript" src="PCBusiness/jdgk/pc.jdgk.month.task.list.js"></script>
	</head>
	<body>
