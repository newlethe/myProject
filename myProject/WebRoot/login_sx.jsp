...
#bg2{
	width:1000px;
	height:298px;
	background:url(jsp/res/images/login_sx/login_003.jpg) 0 0 no-repeat;
	padding:0;
    margin:0;
}
#bg3{
		...
		function init() {
			...
			/*Ext.Ajax.request({
				...
				success : function(response, params) {
					...
					document.forms[0].verifycode.value = rtn;
				},
...
<body>
   <div id="Main">
      <div id="bg1"><img src="jsp/res/images/login_sx/login_002.jpg" /></div>
	  <div id="bg2">
		  <div id="member">
	  ...
	  <div id="bg3"><p>山西国际电力集团有限公司  版权所有</p></div>
   </div>
