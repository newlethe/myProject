...
<html>
  <head>
    ...
    <script type='text/javascript' src='dwr/interface/reimburseMgm.js'></script>
    <script type='text/javascript' src='<%=path%>/dwr/interface/gantDwr.js'></script>
	<script type='text/javascript' src='<%=path%>/dwr/interface/db2Json.js'></script>   
	<script type="text/javascript" src="Business/reimburse/re_info_addorupdate.js"></script>
	...
	<script type="text/javascript">
		...
		/* 流程任务调用所提供的参数 */
		var bh_flow = "<%=(String)request.getParameter("bh") %>";
	</script>	
