...
<html>
	<head>
		...
		var g_balid = "<%=request.getParameter("balid")==null?"":request.getParameter("balid") %>";
		...
		<script type="text/javascript" src="Business/contract/cont.balance.addorupdate.js"></script>
		<style type="text/css">
		</style>
