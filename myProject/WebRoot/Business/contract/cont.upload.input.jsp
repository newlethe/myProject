...
<html>
	<head>
	   ...
	   <link rel="stylesheet" type="text/css" href="jsp/res/css/style.css" />
		...
		<script type="text/javascript" src="jsp/zlgl/Query.js"></script>
       <script type="text/javascript" src="Business/contract/cont.upload.input.js"></script>
	<style type="text/css">
			#loading-mask{
				position:absolute;
				left:0;
	...
	<body>
		...
		<div id="uploadWin" style='display:none' class='uploadWin'>
			<div id="uploadDiv">
				<iframe id="uploadIFrame" name="uploadIFrame" style="width:100%; height:100%" src="jsp/test/test.uploadFile.htm" ></iframe>
			</div>
