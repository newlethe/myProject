...
<html>
	<head>
		...
		var conname = "<%=request.getParameter("conname")==null?"":request.getParameter("conname")%>";
		...
		<!-- PAGE -->
		<script type="text/javascript" src="Business/contract/cont.compensate.input.js"></script>
