...
<html>
	<head>
	   ...
	   <link rel="stylesheet" type="text/css" href="jsp/res/css/style.css" />
        ...
        <script type="text/javascript" src="Business/document/da.dept.input.js"></script>
	    <style type="text/css">
			#loading-mask{
				position:absolute;
				left:0;
	...
	<body>
		...
		<div id="dazjWin" style='display:none'>
			<div id="dazjDiv">
				<iframe id="dazjIFrame" name="dazjIFrame" style="width:100%; height:100%" src="Business/document/da.zl.info.jsp"></iframe>
			</div>
		</div>
