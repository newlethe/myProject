	...
	<head>
	   ...
	   <link rel="stylesheet" type="text/css" href="jsp/res/css/style.css" />
		...
		<script type="text/javascript" src="extExtend/FileUploadField.js"></script>
		 <script type="text/javascript" src="Business/document/da.select.tree.js"></script>
		 <script type="text/javascript" src="Business/document/Query.js"></script>
        <script type="text/javascript" src="Business/document/da.zl.jy.addorupdate.js"></script>
	<style type="text/css">
			#loading-mask{
				position:absolute;
				left:0;
