...
<html>
	<head>
	   ...
	   <link rel="stylesheet" type="text/css" href="jsp/res/css/style.css" />
		...
		<script type="text/javascript" src='Business/document/da.zl.info.nextSelects.js'></script>
        ...
        <script type="text/javascript" src="Business/document/da.zj.js"></script>
	    <style type="text/css">
			#loading-mask{
				position:absolute;
				left:0;
	...
	<body>
		...
		<div id="dazjWin" style='display:none'>
			<div id="dazjDiv">
			<!-- Business/document/da.zl.info.jsp -->
