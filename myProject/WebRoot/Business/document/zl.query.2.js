...
Ext.onReady(function() {
	...
	//var userid;
	zlMgm.getparentid(USERORGID,function(value){  
			parentnone=value;
       	});
   ...
   //alert(USERORGID)
	...
	ds = new Ext.data.Store({
		baseParams : {
			...
			business : business,
			method : listMethod,
			params : " orgid='" + parentnone + "' and  indexid like '"
...
//			forceFit : true,
	...
	ds.load({
		params : {
			start : 0,
			limit : PAGE_SIZE,
			arams : "  orgid='" + parentnone + "' and  indexid like '"
					+ selectedTreeData + "%' and  (billstate=2 or billstate=3) "
		}
	});
   ...
   ////////////////////////////////////////////////////////////	// //////////////////////////////////////////
	...
	treePanel.on('click', function(node) {
		...
		ds.baseParams.params = " orgid='" + parentnone + "' and  indexid like '"
				+ selectedTreeData + "%' and  (billstate=2 or billstate=3) "
		ds.load({
			params : {
				start : 0,
