	...
	<head>
	   ...
	   <link rel="stylesheet" type="text/css" href="jsp/res/css/style.css" />
		...
		<script type="text/javascript" src="extExtend/FileUploadField.js"></script>
		 ...
		 <script type="text/javascript" src="Business/document/Query.zl.dept.js"></script>
        <script type="text/javascript" src="Business/document/zl.mydept.input.js"></script>
	<style type="text/css">
			#loading-mask{
				position:absolute;
				left:0;
