	...
	<head>
	   ...
	   <link rel="stylesheet" type="text/css" href="jsp/res/css/style.css" />
		...
		<script type="text/javascript" src="extExtend/columnNodeUI.js"></script>
		 ...
		 <script type="text/javascript" src="Business/document/zlpept.Query.js"></script>
        <script type="text/javascript" src="Business/document/zl.dept.query.js"></script>
	<style type="text/css">
			#loading-mask{
				position:absolute;
				left:0;
