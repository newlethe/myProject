...
<html>
	<head>
	   ...
	   <link rel="stylesheet" type="text/css" href="jsp/res/css/style.css" />
		...
		<script type='text/javascript' src='/frame/dwr/interface/baseDao.js'></script>
		...
		<script type="text/javascript">
		    ...
		    var uploaded = false;
		    var uploadFileInfo
		    var selectdaid = "<%= request.getParameter("id")==null?"":request.getParameter("id")%>";
		</script>
		...
		<script type="text/javascript" src="Business/document/zl.dept.input.select.tree.js"></script>
		<script type="text/javascript" src="Business/document/flw.adjunct.js"></script>	
        <script type="text/javascript" src="Business/document/da.zl.info.js"></script>
	    <style type="text/css">
			#loading-mask{
				position:absolute;
				left:0;
