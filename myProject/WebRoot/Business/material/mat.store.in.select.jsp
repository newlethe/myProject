...
<html>
	<head>
		...
		<script type="text/javascript" src="Business/material/mat.goods.check.sub.js"></script>
		<script type="text/javascript" src="Business/material/mat.store.in.select.js"></script>
		<style type="text/css">
			#loading-mask{
				position:absolute;
				left:0;
