...
<html>
	<head>
		...
		<script type="text/javascript" src="Business/material/mat.goods.invoice.sub.js"></script>
		<script type="text/javascript" src="Business/material/mat.contract.select.js"></script> 
		<script type="text/javascript" src="Business/material/mat.goods.invoice.js"></script>
		<style type="text/css">
			#loading-mask{
				position:absolute;
				left:0;
