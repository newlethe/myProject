...
<html>
	<head>
		...
		<script type="text/javascript" src="Business/equipment/equ.getGoods.grid.js"></script>    
		<script type="text/javascript" src="Business/equipment/equ.getGoods.input.js"></script> 
		<script type="text/javascript" src="Business/equipment/equ.select.equipment.js"></script>
