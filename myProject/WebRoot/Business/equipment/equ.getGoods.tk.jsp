...
<html>
	<head>
		...
		<script type="text/javascript" src="Business/equipment/equ.tkGoods.grid.js"></script>    
		<script type="text/javascript" src="Business/equipment/equ.getGoods.tk.js"></script> 
