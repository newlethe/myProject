 ...
 <html>
	<head>  
		...
		<script type="text/javascript">
			var masteruids = '<%=request.getParameter("masteruids") == null ? "" : request.getParameter("masteruids") %>';
		...
		<script type="text/javascript" src="Business/equipment/equMgm/equ.special.tools.selectWin.js"></script>
	</head>
	<body>
	</body>
</html>