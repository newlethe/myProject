...
Ext.onReady(function(){
	var gridPanelName = CURRENTAPPID == "1031902"? "设备/材料库存":"设备库存";
	var fm = Ext.form;
	...
	var conidArray = new Ext.data.SimpleStore({
    	fields: ['k', 'v'],   
        data: conArr
    });
    //查询表单
...
//			'<font color=#15428b>规格型号：</font>', ggxh, '-', doSelect, '-']
//	});
...
//				return output;           
    ...
    ds.on("beforeload",function(){
    	...
    	if(ds.baseParams.params!=""){//过滤出库单已经选中的设备
    		...
    		ds.baseParams.params+=" stockNum>0 and (judgment='equ' or judgment is null)";
    	}
    })
...
//			'<font color=#15428b>设备部件名称：</font>', equPartName, '-', 
//			'<font color=#15428b>规格型号：</font>', ggxh, '-', doSelect, '-'],
		tbar:['<font color=#15428b><B>'+gridPanelName+'<B></font>','-'],
		stripeRows: true,
		loadMask: true,
		viewConfig: {
			forceFit: false,
