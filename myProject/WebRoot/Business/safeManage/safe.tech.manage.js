...
Ext.onReady(function (){
    ...
    var cm = new Ext.grid.ColumnModel([		// 创建列模型
    	sm, {
           ...
           width: 100,
           editor: new fm.TextField(fc['department'])
        }, {
           id:'sex',
           ...
           width: 80,
           editor: new fm.TextField(fc['birthday'])
        }, {
           id:'position',
           header: fc['position'].fieldLabel,
           dataIndex: fc['position'].name,
           width: 80,
            editor: new fm.TextField(fc['position'])
        }, {
           id:'education',
