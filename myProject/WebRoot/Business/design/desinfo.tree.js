...
var rootText = "设计文件分类";
var indexid;
var beanName = "com.sgepit.pmis.design.hbm.DesignInfoTree";
...
Ext.onReady(function (){
	...
	function up(){
		...
		designMgm.upzltreenode(treeid,indexid,parenttemp);
		var baseParams = treePanel.loader.baseParams
			...
			Ext.Msg.show({
				...
				fn: function(value){
					if ("yes" == value){
						...
						designMgm.deleteDesignInfoChildNode(nodeid, function(flag) {
							if ("0" == flag) {
	...
	function onClick(node, e){
		...
		obj.mc=mcText;
		obj.treeid=menu_id;
		obj.bm=elNode.all("bm").innerText;
		obj.isleaf=menu_isLeaf;
		obj.indexid=indexid;  
		obj.parent=parenttemp;	
