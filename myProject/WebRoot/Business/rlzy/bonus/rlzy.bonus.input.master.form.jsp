...
<html>
  <head>
	...
	<script type='text/javascript' src='dwr/interface/HrSalaryMgm.js'></script>
	...
	<!-- EXT -->
	<script type="text/javascript" src="Business/rlzy/bonus/rlzy.bonus.input.master.form.js"></script>
