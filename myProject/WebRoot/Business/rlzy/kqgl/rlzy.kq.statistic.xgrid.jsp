...
var mygrid = new dhtmlXGridObject('gridbox');
	...
	function doReload() {
		...
		rlzyKqglMgm.getKqStatXml(startSj, endSj, depts, users, function(dataXml){
	...
	function loadHeader(){
	rlzyKqglMgm.getKqStatXml(null, null, null, null, function(dataXml){
			mygrid.loadXMLString(dataXml);
		});
	}
	
	function exportExcel(){
		saveToPOIExcel(mygrid, '考勤统计');
