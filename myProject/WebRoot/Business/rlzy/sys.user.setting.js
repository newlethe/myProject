...
var selectedOrgIdWin = defaultOrgRootId;
...
//           ,editor: new fm.ComboBox(fc['orgid'])
           //,editor: new fm.TextField(fc['orgid'])
        },  {
           id:fc['posname'].name,
           ...
           var  str;
              ...
              str=value+'/'+ds.data.orgname;
              
              }
           return str;
           },
           width: 110
//           ,editor: new fm.TextField(fc['posname'])
        },{
           id:fc['orgname'].name,
           ...
           hidden:true,
           width: 130
//           ,editor: new fm.TextField(fc['orgname'])
        }, {
           id:fc['posid'].name,
...
//           ,editor: new fm.ComboBox(fc['posid'])
           //,editor: new fm.TextField(fc['posid'])
        },{
...
//           hidden: true,
	...
	function changeWork(obj){
        var record=obj.record;
	       DWREngine.setAsync(true);
	    	rlzyMgm.CalWorkExp(record.get('entryDate'),function(rtn){
...
/*    function saveFun(){
    ...
    treePanelWin.on('click', function(node, e){
		...
		var paramStrCurWin = "unitType"+SPLITB+selectedTypeWin + SPLITA 
		                + "posid" + SPLITB +node.id
		if (selectedOrgIdWin==defaultOrgRootID)
		{
			paramStrCurWin ="";
		}
