...
<html>
	<head>
		...
		<script type='text/javascript' src='<%=path%>/dwr/interface/zlaqMgmImpl.js'></script>
		<script type='text/javascript' src='<%=path%>/dwr/interface/systemMgm.js'></script>
		<script type="text/javascript" src="<%=path%>/Business/jsp/common/fileUploadMulti/fileUploadMulti.js"></script>
		<script type="text/javascript" src="<%=path%>/Business/zlaq/gcwj/Tree.js"></script>
		<script type="text/javascript" src="<%=path%>/Business/zlaq/gcwj/FileGrid.js"></script>
		<script type="text/javascript" src="<%=path%>/Business/zlaq/gcwj/FileModelGrid.js"></script>
		<script type="text/javascript" src="<%=path%>/Business/zlaq/gcwj/Layout.js"></script>
  </head>
