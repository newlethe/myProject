...
Ext.onReady(function() {
	...
	treePanel = new Ext.tree.TreePanel({
		...
		},'->','操作提示:新增和编辑分类通过鼠标右键实现;移动分类通过拖拽操作实现'],
		collapsible : true,
		enableDD : true,
		margins : '5 0 5 5',
		cmargins : '0 0 0 0',
		    ...
		    items: [
		        {
		            id: 'addNode',
		            handler: rMenuFun,
		            icon: "images/icons/toolbar_item_add.png",
		        ...
		        },
		        {
		            id: 'editNode',
		            handler: rMenuFun,
		            icon: "images/icons/toolbar_item_edit.png",
            		cls: "x-btn-text-icon bmenu",
		            text: '修改分类名称'
		        },'-',
		        {
		            id: 'deleteNode',
		            handler: rMenuFun,
		            icon: "images/icons/toolbar_item_delete.png",
            		cls: "x-btn-text-icon bmenu",
		            text: '删除分类'
		        }
		    ]
