...
<html>
	<head>
		...
		<script type="text/javascript" src="Business/finalAccounts/basicData/fa.assets.sort.form.js"></script>
		<script type="text/javascript" src="Business/finalAccounts/basicData/fa.assets.sort.js"></script>
	</head>
	<body >
		<br><span></span>
	<br></body>
