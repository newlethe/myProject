...
<html>
  <head>
	...
	<script type='text/javascript'>
		...
		var month = "<%=request.getParameter("month")==null?"":request.getParameter("month")%>";
		var report_Cont_uuid = "<%=request.getParameter("contuuid")==null?"":request.getParameter("contuuid")%>";
	</script>
	
	<script type="text/javascript" src="Business/routine/gz.month.report.list.addorupdate.js"></script>
