...
var bean = "com.sgepit.pmis.gczl.hbm.Gczltjzb"
var business = "baseMgm"
var listMethod = "findwhereorderby"
var primaryKey = 'uids'
var orderColumn = 'bh'

var bean_fw = "com.sgepit.pmis.gczl.hbm.Gczltjxb"
...
Ext.onReady(function(){
	...
	stockMgm.getStockPlanNewBh(maxStockBhPrefix,"bh","Gczltjzb",null,function(dat){
		if(dat != "")	{
			maxStockBh = dat;
	...
	gridPanel = new Ext.grid.EditorGridTbarPanel({
		...
		tbar : ['<font color=#15428b><B>工程质量停机记录主表<B></font>'],
	...
	var fc_fw = {
		...
		'xh':{name:'xh',fieldLabel:'序号',anchor:'95%'},
		'yy':{name:'yy',fieldLabel:'<font color=red>停机原因</font>',anchor:'95%'},
		'bz':{name:'bz',fieldLabel:'<font color=red>备注</font>',anchor:'95%'},
		'tjsj':{name:'tjsj',fieldLabel:'<font color=red>停机时间</font>',format: 'Y-m-d',anchor:'95%'},
		'jz':{name:'jz',fieldLabel:'机组',anchor:'95%'}
	}
	...
	var cm_fw = new Ext.grid.ColumnModel([
		...
		{	id:'xh',    	 header:fc_fw['xh'].fieldLabel,      	dataIndex:fc_fw['xh'].name,       width:90,editor:new fm.TextField(fc_fw['xh'])},
		...
		{	id:'tjsj',  	 header:fc_fw['tjsj'].fieldLabel,       dataIndex:fc_fw['tjsj'].name,     width:90,editor:new fm.DateField(fc_fw['tjsj'])  ,renderer:formatDate },
	...
	gridPanel_fw = new Ext.grid.EditorGridTbarPanel({
		...
		header : false,
		autoScroll : true, // 自动出现滚动条
		tbar : ['<font color=#15428b><B>工程质量停机记录<B></font>',addBtn,saveBtn,delBtn],
		animCollapse : false, // 折叠时显示动画
		loadMask : true, // 加载时是否显示进度
		stripeRows: true,
		viewConfig : {
