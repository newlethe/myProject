...
<html>
	<HEAD>
		...
		<% 
			String selectedxmbh = "jyjl"+request.getParameter("xmbh");
		%>
		
		
		<script type="text/javascript" src="extExtend/columnNodeUI.js"></script>
		<script type="text/javascript" src="extExtend/FileUploadField.js"></script>
		<script type="text/javascript" src="Business/gczl/gczl.jyjl.file.js"></script>
		<!-- PAGE -->
		<script type="text/javascript">
			var selectedxmbh = "<%=selectedxmbh%>";
