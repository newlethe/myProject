...
var g_canOlEdit= <%=canOnlineEdit%>;
		...
		<script type='text/javascript'
			src='<%=path%>/Business/fileAndPublish/search/com.fileSearch.publish.query.left.js'>
</script>

		<!-- 功能JS -->
		<script type='text/javascript'
			src='<%=path%>/Business/fileAndPublish/search/com.fileSearch.publish.query.js'>
</script>
		<script type='text/javascript'
			src='<%=path%>/Business/fileAndPublish/search/searchField.js'>
</script>
