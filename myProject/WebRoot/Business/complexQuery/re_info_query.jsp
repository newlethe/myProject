...
<html>
  <head>
	...
	<script type="text/javascript" src="Business/complexQuery/re_info_query.js"></script>
	...
	<script type="text/javascript">
		...
		/* 流程任务调用所提供的参数 */
		var bh_flow = "<%=(String)request.getParameter("MEMO")==null?"": (String)request.getParameter("MEMO")%>";
	</script>	
