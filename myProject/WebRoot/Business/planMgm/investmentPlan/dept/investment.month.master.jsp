...
<html>
	...
	<script type="text/javascript">
		...
		Ext.onReady(function(){
			...
			monthArray = [['01','1月'],['02','2月'],['03','3月'],['04','4月'],['05','5月'],['06','6月'],['07','7月'],['08','8月'],['09','9月'],['10','10月'],['11','11月'],['12','12月']];	
			...
			var cm = new Ext.grid.ColumnModel([
				new Ext.grid.RowNumberer(),sm,{
					...
					id:'month',
					type:'combo',
					header:mainFc['month'].fieldLabel,
					dataIndex:mainFc['month'].name,
					editor:new Ext.form.ComboBox(mainFc['month']),
					renderer: getMonthFun,
					width:100
				},{
					id:'operator',
			...
			var mainDs = new Ext.data.Store({
				baseParams:{
					...
					business:business,
					method:listMethod,
					params: "business_Type='" + parent.businessType + "' and length(sj_type)=6 and unit_id ='" + USERDEPTID + "'"
				},
		...
		//		height:230,
			...
			function getMonthFun(value, m, rec){
				if(value && value!="") {
			        return value + '月';
				} else {
			        return rec.data["sjType"] ? (rec.data["sjType"].substring(4,6)+'月') : '';
				}
		    };
		});
