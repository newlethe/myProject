...
//		{name: 'declpro', type: 'string'},
//		{name: 'checkpro', type: 'string'},
		{name: 'ratiftpro', type: 'string'},
    ...
    var cm = new Ext.grid.ColumnModel([
    	...
    	new Ext.grid.RowNumberer(),
    	{
          ...
          // hidden: true,
	 		...
	 		//截止上月累计工程量
		 	var sql="select sum(replace(ratiftpro,'%',''))sumv from pro_acm_info where conid='"+conid+"' and proid='"+proid+"' and mon_id in(select uids from pro_acm_month t where conid='"+conid+"' and t.month<="+sjType+")";
		 	//Ext.log(sql);
