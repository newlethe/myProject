...
<html>
	<head>   
		<title>主体设备入库单稽核，主体材料入库单稽核</title>
		...
		<script type="text/javascript">
			...
			var tree_flag = treeFlag.substring(0,treeFlag.length - 2);
		</script>
		<script type="text/javascript" src="Business/wzgl/storage/wz.stock.intoAndOut.tree.js"></script>
		<script type="text/javascript" src="Business/wzgl/storage/wz.into.warehousing.audit.js"></script>
	</head>
	<body >
	</body>
</html>
