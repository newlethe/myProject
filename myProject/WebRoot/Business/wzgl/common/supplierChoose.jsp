...
<html>
	<head>
		...
		<script type="text/javascript" src="Business/wzgl/common/supplierChoose.js"></script>
		<script type="text/javascript" src="Business/wzgl/common/supplierChooseKind.js"></script>
	    <style type="text/css">
		</style>
	</head>
	<body>
