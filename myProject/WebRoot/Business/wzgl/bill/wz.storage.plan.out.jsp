...
<html>
	<head>
		...
		<script type="text/javascript" src="Business/wzgl/bill/wz.storage.plan.out.js"></script>
		<script type="text/javascript" src="Business/wzgl/bill/wz.storage.plan.out.selectWz.js"></script>
	</head>
	<body>
