	...
	<head>
	   ...
	   <link rel="stylesheet" type="text/css" href="jsp/res/css/style.css" />
		...
		<script type="text/javascript">
			...
			var isuse="<%=request.getParameter("isuse")==null?"":request.getParameter("isuse")%>";
		</script>
		<!-- PAGE -->
		<script type="text/javascript" src="Business/wzgl/baseinfo/wz.baseinfo.wzbm.addorupdate.js"></script>
	    <style type="text/css">
		</style>
	</head>
	<body>
