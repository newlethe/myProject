   ...
   fc={
    ...
    function insertFun(){
    	if(selectedTreeData==null){
    		...
    		var url = BASE_PATH+"Business/wzgl/baseinfo/wz.baseinfo.wzbm.addorupdate.jsp?flbm="+selectedTreeData+"&&flmc="+selectedTreeData_text;
    ...
    function toEditHandler(){
    	if(gridPanel.getSelectionModel().getSelected()){
    		...
    		var url = BASE_PATH+"Business/wzgl/baseinfo/wz.baseinfo.wzbm.addorupdate.jsp?flbm="+selectedTreeData+"&&bm="+record.get('bm')+"&&uids="+record.get('uids');
			window.location.href = url;
    	}
    }
