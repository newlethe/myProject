...
<html>
	<head>
		...
		<!-- PAGE -->
		<script type="text/javascript" src="Business/wzgl/bill_guoj/wz.storage.storageOut.js"></script>
	    <style type="text/css">
	    .btn1_mouseout {
		...
		<%
			String flwbh=request.getParameter("bh") ==null?"":request.getParameter("bh");
		 %>
