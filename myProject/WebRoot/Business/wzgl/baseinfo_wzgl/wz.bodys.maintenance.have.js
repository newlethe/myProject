...
Ext.onReady(function(){
	  ...
	  //设备合同分类树
	   ...
	   var equBodysSql = "select uids,equ_name from wz_goods_bodys where conid='"+edit_conid+"' order by equ_no asc";
...
//            hidden : true,
	...
	var gridPanelPart = new Ext.grid.EditorGridTbarPanel({
		...
		title : '部件明细',
		clicksToEdit : 1,
		tbar : ['<font color=#15428b><B>部件明细<B></font>','-','主体材料名称：','<font color=#15428b><B>【'+edit_equName+'】<B></font>'],//,'-',copyBtn,'-',pasteBtn,'-',downloadBtn,'-',excelInput,'-'
		header: false,
