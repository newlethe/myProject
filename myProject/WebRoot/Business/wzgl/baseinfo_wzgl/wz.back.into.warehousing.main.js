// 材料冲回入库主页
var bean = "com.sgepit.pmis.wzgl.hbm.WzGoodsStoreinBack";
var business = "baseMgm";
var listMethod = "findWhereOrderby";
var primaryKey = "uids";
var orderColumn = "uids";

var beanSub = "com.sgepit.pmis.wzgl.hbm.WzGoodsStoreinBackSub";
...
Ext.onReady(function() {
	...
	var cm = new Ext.grid.ColumnModel([
		...
		id : 'warehouseNoNo',
		header : fc['warehouseNoNo'].fieldLabel,
		dataIndex : fc['warehouseNoNo'].name,
		align : 'center',
		width : 280 		
	}, {
		id : 'warehouseDate',
    ...
    function doPrint(){
        ...
        var filePrintType = "WzStoreinBackView";
...
//            window.open(docUrl)
   ...
   var  chooseRow = new Ext.form.MultiSelect({
	...
	var fcSub = {
        ...
        'taxes' : {name : 'taxes', fieldLabel : '税金',decimalPrecision:2},
        'totalnum' : {name : 'totalnum', fieldLabel : '合计',decimalPrecision:2},
	...
	function addOrUpdateFun(btn) {
		...
		if (btn.id == 'addBtn') {
			...
			url += "?conid=" + selectConid + "&treeuids=" + selectConid+"&edit_flag=chrk"+"&flagLayout="+edit_flagLayout
		} else {
		    return;
		}
		...
		if (finished == null || finished == "") {
			...
			Ext.Msg.confirm("信息提示", "删除后不能恢复，是否要删除", function(btn) {
						if (btn == 'yes') {
							...
							DWREngine.setAsync(false);
							wzbaseinfoMgm.delWzRkGoodsStoreinBack(uids, flag, pid,
									function(text) {
										if (text == 'success') {
...
//    }
	DWREngine.setAsync(false);
	wzbaseinfoMgm.judgmentWzBackFinished(uids, exceOr, pid,flag,'暂估入库', function(index) {
		if (index == '2') {
