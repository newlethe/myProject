//设备开箱通知单弹出框
var beanNotice = "com.sgepit.pmis.wzgl.hbm.WzGoodsOpenbox";
...
//TODO : ======选择开箱通知单======
   var fcNotice = {
	...
	var smNotice = new Ext.grid.CheckboxSelectionModel({singleSelect: true,hidden:''});
    ...
    dsNotice = new Ext.data.Store({
			baseParams: {
		    	...
		    	params: "open_no not in (select noticeNo from WzGoodsStorein t " +
