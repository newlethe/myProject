...
Ext.onReady(function(){
	...
	var fc = {
		...
		'content':{name:'content',fieldLabel:'工作内容',allowBlank: false,anchor:'95%',readOnly:true},
		'planmoney':{name:'planmoney',fieldLabel:'计划费用',allowBlank: false,anchor:'95%'},
		'enddate':{name:'enddate',fieldLabel:'工作完成日期',format: 'Y-m-d',anchor:'95%',allowBlank: false,readOnly:true},
		'sbsj':{name:'sbsj',fieldLabel:'上报日期',format: 'Y-m-d',anchor:'95%',allowBlank: false,readOnly:true},
		'fzr':{name:'fzr',fieldLabel:'负责人',anchor:'95%',readOnly:true},
		'deptuser':{name:'deptuser',fieldLabel:'分管领导审批',anchor:'95%',readOnly:true},
		'zbr':{name:'zbr',fieldLabel:'制表人',anchor:'95%',readOnly:true},
		'memo':{name:'memo',fieldLabel:'备注',anchor:'95%',readOnly:true},
		'memo1':{name:'memo1',fieldLabel:'备用字段',hidden:true,hideLabel:true,anchor:'95%'},
		'dept':{name:'dept',fieldLabel:'上报部门',anchor:'95%',hidden:true,hideLabel:true},
		'jhzt':{name:'jhzt',fieldLabel:'计划状态',anchor:'95%',hidden:true,hideLabel:true},
		'billState':{name:'billState',fieldLabel:'执行状态',anchor:'95%',hidden:true,hideLabel:true},
		'ifbl':{name:'ifbl',fieldLabel:'是否补录',anchor:'95%',hidden:true,hideLabel:true},
