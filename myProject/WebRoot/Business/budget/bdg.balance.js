...
Ext.onReady(function (){
	...
	var btnReturn = new Ext.Button({
		...
		iconCls: 'returnTo',
		handler: function(){
			window.location.href = CONTEXT_PATH + '/Business/budget/bdg.generalInfo.input.jsp?conids='+CONIDS+"&uids="+UIDS+"&optype="+OPTYPE;
		}
	});
	...
	var btnBal = new Ext.Button({
		...
		handler: function(){
			...
			var url = BASE_PATH+"Business/budget/bdg.balance.apportion.jsp?";
			window.location.href = url + "conno=" +selectedConNo +"&conid="+selectedConId+"&conname=" + selectedConName + "&balid=" + record.get('balid');
		}
	});
	...
	function contextmenu(thisGrid, rowIndex, e){
	    ...
	    var gridMenu = new Ext.menu.Menu({
	        ...
	        items: [{
		                ...
		                handler :function (){
								 	var url = BASE_PATH+"Business/budget/bdg.balance.apportion.jsp?";
									window.location.href = url + "conid="+selectedConId+"&conname=" + selectedConName + "&balid=" + record.get('balid');
								}
                    }]
	    });
