...
var gridPanelTitle = "招标委员会:"+ selectedConName + " 编号：" + selectedConNo;
...
Ext.onReady(function (){
    ...
    var cm = new Ext.grid.ColumnModel([		// 创建列模型
    	...
    	{
           id:'cleid',
           header: fc['cleid'].fieldLabel,
           dataIndex: fc['cleid'].name,
           hidden: true,
           width: 60
        },{
           id:'pid',
           ...
           id:'clepid',
           header: fc['clepid'].fieldLabel,
           dataIndex: fc['clepid'].name,
          renderer: renderTenNo,                        /*jhfghfgbfdgdfgfg*/
           width: 120
        },{
           id:'cleno',
           header: fc['cleno'].fieldLabel,
           dataIndex: fc['cleno'].name,
        //   hidden: true,
           width: 120
        },{
           id:'clename',
           header: fc['clename'].fieldLabel,
           dataIndex: fc['clename'].name,
          // renderer: formatDate,
        //  hidden: true,
           width: 120
           ...
           id:'cledate',
           header: fc['cledate'].fieldLabel,
           dataIndex: fc['cledate'].name,
           width: 90
          //renderer: 'usMoney'
          // editor: new fm.DateField(fc['teninputdate'])
        },{
           id:'clemaintype',
           header: fc['clemaintype'].fieldLabel,
           dataIndex: fc['clemaintype'].name,
           hidden: true,
           width: 120
        },{
           id:'clemoney',
           header: fc['clemoney'].fieldLabel,
           dataIndex: fc['clemoney'].name,
          // renderer: formatDate,
        //  hidden: true,
           width: 120
           ...
           id:'cletomoney',
           header: fc['cletomoney'].fieldLabel,
           dataIndex: fc['cletomoney'].name,
           width: 90
          //renderer: 'usMoney'
          // editor: new fm.DateField(fc['teninputdate'])
        }
   ...
   grid.on('rowcontextmenu', contextmenu, this); 
    ...
    function insertFun(){
        window.location.href = baseUrl+"Business/tenders/tender.uniInfo.edit.jsp";//"?tenid='" + param + "'&tid='" + selectedConId + "'";
    ...
    function updateFun(){
     var selectRow = sm.getSelected();
        ...
        var param = null;
        if (selectRow)
        param = selectRow.get('cleid');
         window.location.href = baseUrl+"Business/tenders/tender.uniInfo.edit.jsp?cleid='" + param + "'&tid='" + selectedConId + "'";
     ...
     DWREngine.setAsync(false);
   		tendersMgm.delTenUni(param, function(flag){
   			if ("0" == flag){
   		...
   		DWREngine.setAsync(true);
     window.location.href = baseUrl+"Business/tenders/tender.uniInfo.input.jsp";
