...
Ext.onReady(function (){
    ...
    var cm = new Ext.grid.ColumnModel([		// 创建列模型
    	...
    	{
           id:'comid',
           header: fc['comid'].fieldLabel,
           dataIndex: fc['comid'].name,
           hidden: true,
           width: 60
        },{
           id:'pid',
           ...
           id:'comno',
           header: fc['comno'].fieldLabel,
           dataIndex: fc['comno'].name,
          renderer: renderTenNo,                        /*jhfghfgbfdgdfgfg*/
           width: 120
        },{
           id:'comname',
           header: fc['comname'].fieldLabel,
           dataIndex: fc['comname'].name,
           hidden: true,
           width: 120
        },{
           id:'comdept',
           header: fc['comdept'].fieldLabel,
           dataIndex: fc['comdept'].name,
          // renderer: formatDate,
          hidden: true,
           width: 120
           ...
           id:'comspeci',
           header: fc['comspeci'].fieldLabel,
           dataIndex: fc['comspeci'].name,
           width: 90
          //renderer: 'usMoney'
   ...
   // updateHandler: updateFun,	//自定义修改方法，可选
    ...
    function insertFun(){
        window.location.href = baseUrl+"Business/tenders/tender.ComInfo.edit.jsp";//"?tenid='" + param + "'&tid='" + selectedConId + "'";
    ...
    function updateFun(){
     var selectRow = sm.getSelected();
        ...
        var param = null;
        if (selectRow)
        param = selectRow.get('comid');
         window.location.href = baseUrl+"Business/tenders/tender.ComInfo.edit.jsp?comid='" + param + "'&tid='" + selectedConId + "'";
     ...
     DWREngine.setAsync(false);
   		tendersMgm.delTenCom(param, function(flag){
   			if ("0" == flag){
   		...
   		DWREngine.setAsync(true);
    window.location.href = baseUrl+"Business/tenders/tender.ComInfo.input.jsp";
