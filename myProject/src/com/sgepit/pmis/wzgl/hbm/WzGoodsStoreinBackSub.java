 ...
 */
public class WzGoodsStoreinBackSub implements java.io.Serializable{
	...
	/** default constructor */
	public WzGoodsStoreinBackSub() {
	}

	/** minimal constructor */
	public WzGoodsStoreinBackSub(String uids, String pid) {
		this.uids = uids;
		this.pid = pid;
	}

	/** full constructor */
	public WzGoodsStoreinBackSub(String uids, String ggxh, String memo,
