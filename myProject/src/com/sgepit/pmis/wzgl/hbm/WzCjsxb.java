...
public class WzCjsxb implements java.io.Serializable {
	...
	private String sqhzState;
	private String cghzState;
	private String hzbh;
	
	private String isTd;
	private Double tdTotalNum;
	...
	/** minimal constructor */
	public WzCjsxb(String bh, String bm) {
		this.bh = bh;
		this.bm = bm;
	}

	/** full constructor */
	public WzCjsxb(String pid, String bh, String bm, String pm, String gg,
			...
			String isvalid, Date pzrq, String sqhzState, String cghzState, String hzbh) {
		this.pid = pid;
		this.bh = bh;
		this.bm = bm;
		this.pm = pm;
	...
	public String getSqhzState() {
		return this.sqhzState;
	}
	
	public void setSqhzState(String sqhzState) {
		this.sqhzState = sqhzState;
	}
	...
	public Double getTdTotalNum() {
		return tdTotalNum;
	}

	public void setTdTotalNum(Double tdTotalNum) {
		this.tdTotalNum = tdTotalNum;
	}
