...
public class WzGoodsStoreinEstimate  implements java.io.Serializable {
	...
	/** default constructor */
	public WzGoodsStoreinEstimate() {
	}

	/** minimal constructor */
	public WzGoodsStoreinEstimate(String uids, String pid) {
		this.uids = uids;
		this.pid = pid;
	}

	/** full constructor */
	public WzGoodsStoreinEstimate(String uids, String pid, String conid,
			byte finished, String treeUids, String warehouseNo,String warehouseInType,
			Date warehouseDate, String noticeNo, String warehouseMan,String judgmentFlag,
