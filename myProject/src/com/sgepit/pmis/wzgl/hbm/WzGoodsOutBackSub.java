...
public class WzGoodsOutBackSub implements java.io.Serializable {
	...
	/** default constructor */
	public WzGoodsOutBackSub() {
	}

	/** minimal constructor */
	public WzGoodsOutBackSub(String pid,String stockId, String outId, String outNo) {
		this.pid = pid;
	...
	public WzGoodsOutBackSub(String pid, String stockId,String outId, String outNo,
			...
			String graphNo, String unit, Double outNum, Double price,
			String storage) {
		this.pid = pid;
		this.stockId = stockId;
		this.outId = outId;
