...
public class WzArriveApply implements java.io.Serializable {
	...
	/** default constructor */
	public WzArriveApply() {
	}

	/** minimal constructor */
	public WzArriveApply(String bh, String bm) {
		this.bh = bh;
		this.bm = bm;
	}

	/** full constructor */
	public WzArriveApply(String pid, String bh, String bm, String pm, String gg,
