...
public class ViewWzArriveCgjh implements java.io.Serializable {
	...
	/** default constructor */
	public ViewWzArriveCgjh() {
	}

	/** full constructor */
	public ViewWzArriveCgjh(String uids, String bh, String bm, String pm,
			String gg, String dw, Double curDhsl, String csdm, Double jhdj,
			Double jhzj, Double sjdj, Double sjzj, Double taxRate, Double taxMoney,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ViewWzArriveCgjh))
			return false;
		ViewWzArriveCgjh castOther = (ViewWzArriveCgjh) other;
		...
		return ((this.getUids() == castOther.getUids()) || (this.getUids() != null
				...
				&& ((this.getTaxRate() == castOther.getTaxRate()) || (this
						.getTaxRate() != null
						&& castOther.getTaxRate() != null && this.getTaxRate()
						.equals(castOther.getTaxRate())))
				&& ((this.getTaxMoney() == castOther.getTaxMoney()) || (this
						.getTaxMoney() != null
						&& castOther.getTaxMoney() != null && this
						.getTaxMoney().equals(castOther.getTaxMoney())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getTaxRate() == null ? 0 : this.getTaxRate().hashCode());
		result = 37 * result
				+ (getTaxMoney() == null ? 0 : this.getTaxMoney().hashCode());
		result = 37 * result
