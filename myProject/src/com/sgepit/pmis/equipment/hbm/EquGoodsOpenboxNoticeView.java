...
public class EquGoodsOpenboxNoticeView implements java.io.Serializable{
	private String uids;
	...
	public EquGoodsOpenboxNoticeView() {
		super();
	}

	public EquGoodsOpenboxNoticeView(String uids, String partyB, String conNo,
