...
public class SbCsb implements java.io.Serializable {
	...
	/** minimal constructor */
	public SbCsb(String csdm) {
		this.csdm = csdm;
	}

	/** full constructor */
	public SbCsb(String csdm, String csmc, String gb, String tel, String post,
			String addr, String fax, String fr, String lxr, String email,
			String mobil, String bank, String accountNumber, String taxNumber,
			String bz, String flbm, String isused,String wzorsb,String rate,String appra,String professional) {
		this.csdm = csdm;
		this.csmc = csmc;
		this.gb = gb;
		this.tel = tel;
