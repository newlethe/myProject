 ...
 */
public class EquGoodsStoreinBackSub implements java.io.Serializable{
	...
	/** default constructor */
	public EquGoodsStoreinBackSub() {
	}

	/** minimal constructor */
	public EquGoodsStoreinBackSub(String uids, String pid) {
		this.uids = uids;
		this.pid = pid;
	}

	/** full constructor */
	public EquGoodsStoreinBackSub(String uids, String ggxh, String memo,
