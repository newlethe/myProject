...
public class BudgetBreakAppServlet extends MainServlet {
	...
	private void updateBreakApp(HttpServletRequest request,
		...
		BudgetBreakAppNk breakAppNk = (BudgetBreakAppNk) JSONObject.toBean(
				jsonObject, BudgetBreakAppNk.class);

		budgetBreakAppNkService.saveOrUpdate(breakAppNk);
	...
	private void deleteNode(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
		// 得到节点id
		String breappid = request.getParameter("breappid");
		try {
			budgetBreakAppNkService.delete(breappid);
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (method != null) {
			...
			if (method.equalsIgnoreCase("updateBreakApp")) {
				updateBreakApp(request, response);
