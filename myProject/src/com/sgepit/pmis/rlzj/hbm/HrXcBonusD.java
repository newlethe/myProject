...
public class HrXcBonusD implements java.io.Serializable {
	...
	/** minimal constructor */
	public HrXcBonusD(String detailId, String masterlsh, String sjType,
	...
	public HrXcBonusD(String detailId, String masterlsh, String sjType,
			...
			Double val25, Double val26, Double val27, String memo) {
		this.detailId = detailId;
		this.masterlsh = masterlsh;
		this.sjType = sjType;
		this.unitId = unitId;
