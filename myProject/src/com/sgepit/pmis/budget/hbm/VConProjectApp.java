...
public class VConProjectApp implements java.io.Serializable {
	...
	private Double projectmoney;//合同工程量分摊总金额
	private Double projectchangemoney;//合同工程量变更分摊总金额
	...
	public Double getProjectchangemoney() {
		return projectchangemoney;
	}
	public void setProjectchangemoney(Double projectchangemoney) {
		this.projectchangemoney = projectchangemoney;
	}
