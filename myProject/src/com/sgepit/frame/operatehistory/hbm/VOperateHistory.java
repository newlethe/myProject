...
public class VOperateHistory implements java.io.Serializable {
	...
	/** default constructor */
	public VOperateHistory() {
	}

	/** full constructor */
	public VOperateHistory(String unitId, String operateUser, Date operateTime,
